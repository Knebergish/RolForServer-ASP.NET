	...
	public static class Repo {
		public static List<News> News = new List<News> {
			new News {
				...
				Text =
					"Ну тут что-то написано. Очень много текста, его не так-то просто прочитать. Но читать придётся, " +
					"потому что иначе зачем это всё было написано, как не для почитать?"
			},
			new News {
			...
			new News {
				Title = "Внимание!", Date = DateTime.Now, AuthorId = 0,
				Text =
					"Спасибо за внимание. Ваше внимание очень важно для нас. Мы будем бороться за ваше внимание всеми " +
					"силами. Некоторые говорят, что внимание не важно, но мы так не думаем. Внимание - главная " +
					"ценность, что есть в человеке. Нельзя упускать внимание, иначе можешь упустить что-то важное. "
			}
		};

		public static List<User> Users = new List<User> {
			new User {
				Name = "Аллар Кнебергиш",
				Description =
				...
				AvatarImageName = "Techpriest.jpg"
			},
			new User {
				Name = "Тея",
				Description =
					"Целитель днем, в ночи некромант. Постоялец каморки в таверне \"Огонек\", работница библиотеки. ",
				AvatarImageName = "Teya.jpg"
			},
			new User {
				Name = "Алиум",
				Description =
					"Охотник на нежить. Для него добра и зла как такового нет, потому поддерживает свою сторону, истребляя нечисть. ",
				AvatarImageName = "Alium.jpg"
			}
		};
